(function () {
    ...
    if (isHomePage && !window.__bibliotechBookDetailPolishLoading) {
        ...
        loadStylesheet('css/hero-library-map.css?v=20260710-clean-book-scene-1', '__bibliotechHeroLibraryMapCss');
    ...
    if (isHomePage) {
        loadScript('js/hero-book-scene.js?v=20260710-clean-book-scene-1', '__bibliotechHeroBookSceneLoading');
