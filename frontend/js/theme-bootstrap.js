(function () {
  ...
  var PALETTE_VALUES = {
    ...
    forest: {
      light: ['#edf8f0','#f7fcf8','#ffffff','#ffffff','#e0f1e5','#183021','#5e7867','rgba(30, 93, 54, 0.16)','#2f8a50','#1e6a3a','#d7efdf','#ffffff','#b58d35','#3977a8','#b84d48','#f9e6e3','#26784b','#dbefe3'],
    ...
    ocean: {
      light: ['#eaf7fc','#f7fcfe','#ffffff','#ffffff','#dceff6','#17313d','#5d7682','rgba(23, 93, 121, 0.16)','#178bb3','#0a688b','#d5eff8','#ffffff','#c39638','#2f70b7','#b74e4b','#fae7e5','#247b68','#dcefe9'],
    ...
    sunset: {
      light: ['#fff3e3','#fffaf3','#ffffff','#ffffff','#f8ece1','#38261d','#7a6254','rgba(113, 73, 49, 0.16)','#d96d4a','#aa4b34','#fae4d9','#ffffff','#d5a33e','#3b75a8','#b84f49','#fae7e4','#3c7d57','#e2f0e7'],
