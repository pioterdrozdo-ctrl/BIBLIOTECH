...
assert.ok(pwa.includes('apple-polish.css?v=20260713-apple-polish-5'), 'PWA does not load final Apple CSS');
...
assert.ok(server.includes("'/css/apple-polish.css?v=20260713-apple-polish-5'"), 'server does not preload Apple CSS');
