...
- интерактивная 3D-карта кабинета 125 с поиском книг, доступной 2D-схемой и редактируемыми координатами;
...
- `backend/routes/libraryMap.js` — API навигационной карты и административных координат.
